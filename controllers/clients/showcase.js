...
const Inquiry = mongoose.model('showcase_inquiry', inquirySchema);
...
exports.getHomepage = (req, res, next) => {
  res.render('clients/showcase/parallelism', {
    title: 'Landing Page'
  });
}
...
exports.getInquiry = (req, res, next) => {
  res.render('clients/showcase/inquiry', {
    title: 'Landing Page'
  });
}
...
exports.postInquiry = (req, res, next) => {
  ...
  */
  var bucket_endpoint = "/clients/showcase/inquiries/" + id + "/"
