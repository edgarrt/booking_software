...
const Inquiry = mongoose.model('test_inquiry', inquirySchema);
...
exports.getHomepage = (req, res, next) => {
  res.render('clients/test/astral', {
    title: 'Landing Page'
  });
}

exports.getCatalogue = (req, res, next) => {
  res.render('clients/test/work', {
    title: 'Catalogue'
  });
}
...
exports.getInquiry = (req, res, next) => {
  res.render('clients/test/inquiry', {
    title: 'Inquiry'
  });
}
...
exports.postInquiry = (req, res, next) => {
  ...
  */
  var bucket_endpoint = "/clients/test/inquiries/" + id + "/"
  ...
  */
  ...
  // Moved files (if any) into proper folder
